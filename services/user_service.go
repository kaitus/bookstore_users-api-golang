...
import (
	...
	"github.com/kaitus/bookstore_users-api-golang/utils/crypto_utils"
...
func (s *usersService) UpdateUser(isPatial bool, user users.User) (*users.User, *errors.RestError) {
